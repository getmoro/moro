...
prog
  ...
  .action(clearData)
  .command('config', 'ex. moro config --day 8 Sets  duration of day to 8, and moro config --break 45 sets the default break duration to 45')
  .option('--day <duration>', 'ex. moro config --day 8 How many hours make a full day e.g 7.5', prog.FLOAT)
  .option('--break <duration>', 'moro config --break 45 Sets your proffered default break time to 45 minutes', prog.INT)
  .action(setConfig)
