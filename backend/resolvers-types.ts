...
import { ApolloContext } from './src/server/apolloContext';
...
export type HasRoleDirectiveResolver<Result, Parent, ContextType = ApolloContext, Args = HasRoleDirectiveArgs> = DirectiveResolverFn<Result, Parent, ContextType, Args>;
