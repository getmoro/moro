  ...
  configManager
    ...
    .then(config => {
      ...
      db
        ...
        .then(() => {
          spinner
            .succeed(`Your start of the day registered as ${start}\n\n`)
            .start()
        ...
        db
          ...
          .then(data => {
            if (data && result) {
              ...
              spinner.info(
                'Run moro --help if you need to edit your start, end or break duration for today\n'
              )
              process.exit(0)
            }
          })
  ...
  configManager
    ...
    .then(config => {
      ...
      db
        ...
        .finally(() => {
          spinner
            .succeed('Your note is added! You can see it in report \\o/ ')
            .start()
        })
    })
    .catch(spinner.fail)
