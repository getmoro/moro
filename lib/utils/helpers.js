...
// input momen which also contains days, output formated sum
...
const buildTable = (records, pattern) => {
  ...
  records.forEach((record) => {
    ...
    formattedRecord[date.format(pattern)] = formatWorkHours(workHours)
